<template>
	<div class="review-mgt">
		<div class="btn-group">
			<el-button @click="getNotReview" plain size="small" type="danger">未审核</el-button>
			<el-button @click="getReviewed" plain size="small" type="primary">已审核</el-button>
		</div>
		<div class="table-bg">
			<el-table
					:cell-style="rowStyle"
				...
				<el-table-column
					...
					<template scope="scope">
						<el-button @click="" @click="acceptUpload(scope.row.id)" size="small" type="success"
						           v-show="scope.row.state==0">通过
						</el-button>
						<el-button @click="" @click="denyUpload(scope.row.id)" size="small" type="danger"
